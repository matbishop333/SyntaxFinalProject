...
Feature: Add Employee
  ...
  Scenario: Admin adds a new employee without providing a unique id
    ...
    Given User navigates to the PIM
    And the user clicks on Add button
    And enters the employee's first name "Jane" and last name "Smith"
    And enters a unique employee id "53421333"
    And the user clicks on Save button
    Then the user will be taken to the employee personal details page and sees the employee id "53421333"